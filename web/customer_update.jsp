                                ...
                                <div class="container">  
                                    <%
                                        if (cus_id > 0) {
                                            ...
                                            Customer cus = (Customer) ses.load(Customer.class, cus_id);


                                    %>
                                    <form action="Custommer_update" method="POST">
                                                    ...
                                                    <div class="card-content">
                                                        ...
                                                        <div class="card-content">
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group label-floating is-empty">
                                                                        ...
                                                                        <input type="text" name="name" class="form-control" value="<%=cus.getName()%>">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group label-floating is-empty">
                                                                        ...
                                                                        <textarea name="address" class="form-control"><%=cus.getAddress()%></textarea>
                                                                        <span class="help-block">A block of help text that breaks onto a new line.</span>
                                                                        <span class="material-input"></span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group label-floating is-empty">                                                                       
                                                                        <input type="text"  name="mobile" maxLength="10" class="form-control" value="<%=cus.getMobile()%>">
                                                                        <span class="help-block">A block of help text that breaks onto a new line.</span>
                                                                        <span class="material-input"></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <input type="hidden" id="id" name="id" value="<%=cus_id%>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
