<%-- 
    Document   : grnPayments
    Created on :  Apr 2, 2020, 11:12:18 PM
    Author     : AKILA
--%>
...
<html>
    <head>
        <%
            String PAGE_NAME = "GRN Payment", LOGED_USER_NAME = "", NAME = "", USERNAME = "";
            int LOGED_USER_ID = 0;
            int STAF_ID = 0;
            LogedUserHolder luh;
            DetailsHolder dth;
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-content">
                                        <h3 class="card-title" style="margin-bottom: 15px;">GRN Payment</h3>
                                        <div class="material-datatables">
                                            <table id="grnTable" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                ...
                                                <tbody>
                                                    <%
                                                        List<Grn> grnList = sess.createCriteria(Grn.class).add(Restrictions.gt("balance", 0d)).list();
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%=hlp.priceFormt.format(grnPaymentObj.getCash())%></td>
                                                        <td style="font-weight: bolder; color: #ff0000b5;"><%=hlp.priceFormt.format(grnPaymentObj.getBalance())%></td>
                                                        <td class="text-right">
                                                            <a class="btn btn-success pay" data-ref="<%=grnPaymentObj.getGrnId()%>">Pay Now</a>
                                                        </td>
                                                    </tr>
                                                    <%
                                                        }
        ...
        <div class="modal-dialog">   
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">GRN Payment <button type="button" class="close" data-dismiss="modal" style="margin-bottom: 20px;"><i class="fa fa-close"></i></button></h4>
                </div>
