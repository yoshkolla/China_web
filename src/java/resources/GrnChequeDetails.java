...
public class GrnChequeDetails  implements java.io.Serializable {
    ...
    public GrnChequeDetails(GrnPayment grnPayment, String type, String chequeNo, String chequeDate, String bank, String branch, Double amount, String chequeImage, Integer status) {
       this.grnPayment = grnPayment;
       this.type = type;
