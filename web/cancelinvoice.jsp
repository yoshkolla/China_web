<%-- 
    ...
    Created on : Mar 28, 2020, 8:40:12 PM
    Author     : SCORFi3LD
--%>
...
<html>
    <head>
        <%
            String PAGE_NAME = "Cancel Invoices", LOGED_USER_NAME = "", NAME = "", USERNAME = "";
            int LOGED_USER_ID = 0;
            int STAF_ID = 0;
            LogedUserHolder luh;
            DetailsHolder dth;
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="material-datatables">
                                            <table id="invTable" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                ...
                                                <tbody>
                                                    <%
                                                        List<Invoice> inList = s.createCriteria(Invoice.class).add(Restrictions.eq("status", 1)).list();
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a class="btn btn-danger remove" data-ref="<%=in.getInvoiceId()%>">Cancel</a>
                                                        </td>
                                                    </tr>
                                                    <%
                                                        }
    ...
    <script type="text/javascript">
        ...
        $('.remove').click(function () {
            ...
            swal({
                ...
                if (willCancel) {
                    $.ajax({
                        url: "CancelInvoiceServlet",
                        data: {inv: id},
                        success: function (data) {
                            if (data == "1") {
                                swal("Invoice Canceled!", {
                                    icon: "success",
                                }).then(function () {
                                    location.reload();
                                });
